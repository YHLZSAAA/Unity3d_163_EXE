...
namespace MojingSample.CrossPlatformInput.MojingInput
{
    public class MojingInputManager : MonoBehaviour
    {
        ...
        //------------------
        public string[] buttons = new string[14]{
                "OK",// = 66,
				"C",// = 4,
				"MENU",// = 82,
        ...
        */
        ...
        public class CInputListenerCallBack : AndroidJavaProxy
        {
            ...
            {
            Loom.QueueOnMainThread(()=>{
                Instance.device_name_attach = deviceName;
                Instance.attachstate = AttachState.Connected;
            ...
            {
            Loom.QueueOnMainThread(()=>{
                Instance.device_name_detach = deviceName;
                Instance.attachstate = AttachState.Disconnected;

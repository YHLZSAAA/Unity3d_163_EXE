...
public class MojingSDK
{
    ...
    public static void Unity_SetOverlay3D_V2(int iEyeType, int iTextureID, float fLeft, float fTop, float fWidth, float fHeight, float fDistanceInMetre)
    {
    }

	public static void Unity_SetOverlay3D_V2_Metal(int iEyeType, IntPtr iTextureID, float fLeft, float fTop, float fWidth, float fHeight, float fDistanceInMetre)
	{
	}
    ...
    public static void Unity_AppExit(int iExitCode)
    {
    }
#else
	...
	[DllImport(dllName)]
	public static extern void Unity_SetOverlay3D_V2_Metal(int iEyeType , IntPtr iTextureID, float fLeft, float fTop, float fWidth, float fHeight, float fDistanceInMetre);
	[DllImport(dllName)]
	public static extern void Unity_DestroyMetalLayer();
    [DllImport(dllName)]
	public static extern void Unity_AppExit(int iExitCode);
#endif
    ...
    [DllImport(dllName)]
    public static extern void Unity_SetOverlay3D_V2(int iEyeType, int iTextureID, float fLeft, float fTop, float fWidth, float fHeight, float fDistanceInMetre);
    [DllImport(dllName)]
